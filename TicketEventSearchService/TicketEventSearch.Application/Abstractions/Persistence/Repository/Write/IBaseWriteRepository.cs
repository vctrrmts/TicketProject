using TicketEventSearch.Application.Abstractions.Persistence.Repository.Read;

namespace TicketEventSearch.Application.Abstractions.Persistence.Repository.Write
{

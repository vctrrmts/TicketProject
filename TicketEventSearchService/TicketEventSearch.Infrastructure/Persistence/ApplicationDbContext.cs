...
public class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TicketStatus>().HasKey(s => s.TicketStatusId);
        modelBuilder.Entity<TicketStatus>().Property(e => e.Name).HasMaxLength(20).IsRequired();
        modelBuilder.Entity<TicketStatus>().HasMany(s=>s.Tickets);
